...
export const FollowersPostIcon = props => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
    className="nav-icon"
  >
    <title>Posts from People you follow</title>
    <path
...
export const DeleteBtn = props => (
  <span className="delete-post-btn" {...props}>
...
export const CommentBtn = props => (
  <span {...props} className="comment-btn post-icon">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
      className="post-icon"
...
export const SaveBtn = props => <div className="post-save dn" {...props}></div>;

export const ExploreBtn = props => (
  <svg
    aria-label="Find People"
    className="nav-icon explore"
    fill="#262626"
    height="22"
    viewBox="0 0 48 48"
    width="22"
...
export const SpinLoader = () => (
  ...
  >
    <g transform="rotate(0 50 50)">
      <rect x="49" y="39.5" rx="1" ry="3.5" width="2" height="7" fill="#6a6a6a">
        <animate
...
export const RefreshBtn = ({ isLoading }) => (
  <button className={`refresh ${isLoading ? "loading" : ""}`}>
    <svg
      className="icon"
      height="24"
      viewBox="0 0 24 24"
